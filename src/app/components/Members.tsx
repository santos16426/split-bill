    ...
    return (
        <div className='flex flex-col gap-2'>
            <div className='flex flex-row justify-between items-center'>
                <p className='text-primary font-bold'>Members</p>
            ...
            {activeGroup && activeGroup.members.map((member, index) => {
                return (
                    <div className={cn('flex flex-row justify-between text-primary cursor-pointer',
                        // 'hover:bg-slate-300 hover:bg-opacity-50 hover:p-1 hover:font-bold '
